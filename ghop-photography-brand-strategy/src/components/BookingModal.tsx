          ...
          <div className="p-8 text-center space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
              <a
                ...
                className="w-full sm:w-auto px-4 py-2.5 rounded-full bg-[#121319] border border-neutral-700 text-neutral-200 font-mono text-xs flex items-center justify-center gap-2 hover:border-[#d4af37] transition-all"
                title="Email ghopbusinesscenter@gmail.com"
              >
                <Mail className="w-3.5 h-3.5 text-[#d4af37]" />
                <span>ghopbusinesscenter@gmail.com</span>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-auto px-5 py-2.5 rounded-full bg-[#1877F2] text-white font-bold text-xs uppercase tracking-wider hover:bg-[#166fe5] transition-all flex items-center justify-center gap-2 shadow-lg shadow-[#1877F2]/20"
              >
                <Share2 className="w-3.5 h-3.5" />
                <span>Facebook @GHOPzambia</span>
              </a>
