        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 text-xs">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-neutral-400">
              ...
              <li><a href="#studios" className="hover:text-[#d4af37] transition-colors">Livingstone & Victoria Falls</a></li>
              <li><a href="#studios" className="hover:text-[#d4af37] transition-colors">Copperbelt (Kitwe & Ndola)</a></li>
            </ul>
          </div>
